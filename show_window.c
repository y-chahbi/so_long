...
/*   Updated: 2022/12/24 12:44:07 by ychahbi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	mlx_put_t_data(struct s_data *t_data, int *width, int *height)
{
	...
	t_data->img_exit_2 = mlx_xpm_file_to_image(t_data->mlx, "pics/exit_2.xmp", width, height);
	...
	t_data->img_player_2 = mlx_xpm_file_to_image(t_data->mlx, "pics/player_2.xmp", width, height);
...
void show_the_window(struct s_data *t_data)
{
	...
	t_data->mlx_win = mlx_new_window(t_data->mlx, t_data->map_width * 96, t_data->map_height * 96, "So Long");
